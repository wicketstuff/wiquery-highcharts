		...
		AbstractWHighChartPlotChartOptions<WHighChartPlotColumnOptions>
{
	...
	public WHighChartPlotColumnOptions setColorByPoint(Boolean colorByPoint)
	{
	...
	public WHighChartPlotColumnOptions setMinPointLength(Number minPointLength)
	{
	...
	public WHighChartPlotColumnOptions setPointWidth(Number pointWidth)
	{
